  ...
  const [isPending, startTransition] = useTransition();
    ...
    const handleSubmit = () => {
      ...
      startTransition(async () => {
        const response = await askAIAboutNotesAction([questionText], responses);
    ...
    <Dialog open={open} onOpenChange={handleOnOpenChange}>
      <form>
        ...
        <DialogContent className="custom-scrollbar flex h-[85vh] max-w-4xl flex-col overflow-y-auto" ref={contentRef}>
          ...
          <div className="mt-auto flex flex-row cursor-text rounded-lg border p-4">
            <Textarea
             ref={textareaRef}
             placeholder="Ask me anything about your notes..."
             className="resize-none rounded-none border-none !bg-background placeholder:text-muted-foreground focus-visible:ring-0 focus-visible:ring-offset-0"
             style={{
              minHeight: "0",
              lineHeight: "normal",
             }}
